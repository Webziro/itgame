...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#0f172a] text-white relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] left-[-5%] w-[40%] h-[40%] bg-brand-pink/5 blur-[120px] rounded-full" />
      <div className="absolute bottom-[-10%] right-[-5%] w-[40%] h-[40%] bg-brand-teal/5 blur-[120px] rounded-full" />
      ...
      <nav className="max-w-7xl mx-auto px-6 py-8 flex justify-between items-center relative z-10">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center shadow-lg shadow-brand-pink/5 transform -rotate-6">
        ...
        <div className="flex items-center gap-6">
          {session ? (
            ...
            <>
              <Link href="/auth/signin" className="font-bold text-white/60 hover:text-white transition-colors">
                Login
              </Link>
      ...
      <section className="section-padding relative z-10">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-7 space-y-8">
            ...
            <h2 className="text-6xl lg:text-8xl font-black text-white leading-[0.9] tracking-tight">
              Turn Skills <br/>
            ...
            <div className="grid grid-cols-2 sm:flex sm:flex-wrap gap-4 sm:gap-6 items-center">
              <div className="glass-card p-4 sm:p-6 flex items-center gap-3 sm:gap-4 bg-white/5 border-white/10">
              ...
              <div className="glass-card p-4 sm:p-6 flex items-center gap-3 sm:gap-4 bg-white/5 border-white/10">
                ...
                <div>
                  <div className="text-lg sm:text-2xl font-black text-white">₦2.5M+</div>
          ...
          <div className="lg:col-span-5 relative">
            ...
            <div className="absolute inset-0 bg-brand-pink/10 blur-[60px] rounded-full scale-90" />
            <div className="relative glass-card p-2 bg-white/5 border-white/10">
              <FreeGame />
            </div>
          </div>
        </div>
